...
use admin\controllers\search\CurrencySearch;
...
class CurrencyController extends BaseController
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->resetDefault() && $model->save()) {
            $this->reloadCache();
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->saveCurrencyWithDefault()) {
            $this->reloadCache();
            return $this->redirect(['index']);
        } else {
            return $this->render('update', [
    ...
    /**
     * Activates an existing Currency model.
    ...
    /**
     * Deactivates an existing Currency model.
     * If successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
     */
    ...
    private function reloadCache(){
        Yii::$app->globalCache->addUpdateCacheAction("loadCurrencies()");
    }
